...
{
    public partial class CreateFirstSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TuteeId = table.Column<int>(type: "int", nullable: true),
                    CourseId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MatchingStudents", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MatchingStudents_Students_TuteeId",
                        column: x => x.TuteeId,
                        principalTable: "Students",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MatchingStudents_Students_TutorId",
                        column: x => x.TutorId,
                        principalTable: "Students",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchingStudents_CourseId",
                table: "MatchingStudents",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchingStudents_TuteeId",
                table: "MatchingStudents",
                column: "TuteeId");

            migrationBuilder.CreateIndex(
                name: "IX_MatchingStudents_TutorId",
                table: "MatchingStudents",
                column: "TutorId");
